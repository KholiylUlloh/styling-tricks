window.addEventListener("scroll", function(e) {
    if (e.target.scrollingElement.scrollTop >= 250 && document.getElementById("main").scrollTop <= 300) {
        document.getElementById("main").scroll({top: e.target.scrollingElement.scrollTop-275, behavior: "auto"})
    }
    ...
    if (e.target.scrollingElement.scrollTop <= 770 && document.getElementById("main").scrollTop <= 730) {
